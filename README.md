...
- `number_of_seasons` counts aired official seasons and excludes specials, which TMDB lists as season 0 in the `seasons` array. The number of seasons test accounts for this by filtering out any specials before comparing against the `number_of_seasons`.
